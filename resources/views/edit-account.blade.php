  ...
  <div class="tw-max-w-2xl tw-rounded-lg tw-shadow-xl tw-bg-gray-50">
      <div class="tw-m-4">
          ...
          <div class="tw-flex tw-items-center tw-justify-center tw-w-full">
              <label class="tw-flex tw-flex-col tw-w-full tw-h-32 tw-border-4 tw-border-blue-200 tw-border-dashed hover:tw-bg-gray-100 hover:tw-border-gray-300">
              <div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-pt-7">
                  ...
                  <p class="tw-pt-1 tw-text-sm tw-tracking-wider tw-text-gray-400 group-hover:tw-text-gray-600">Attach a file</p>
              </div>
          </div>
      </div>
  </div>
