    ...
    <div class="tw-flex tw-h-screen tw-antialiased tw-text-gray-900 tw-bg-gray-100 dark:tw-bg-dark dark:tw-text-light">
      ...
      <div class="tw-flex tw-flex-shrink-0 tw-transition-all">
        <div
          ...
          class="tw-fixed tw-inset-0 tw-z-10 tw-bg-black tw-bg-opacity-50 lg:tw-hidden"
        ></div>
        ...
        >
          ...
          <div class="tw-flex tw-flex-col tw-items-center tw-flex-1 tw-p-2 tw-space-y-4">
            <!-- Menu button -->
            <button
              @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
        ...
        <div
          x-transition:enter="tw-transform tw-transition-transform tw-duration-300"
        ...
        >
          <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
            ...
            <div class="tw-flex-1 tw-px-4 tw-space-y-2 tw-overflow-hidden hover:tw-overflow-auto">
              <a href="#" class="tw-flex tw-items-center tw-w-full tw-space-x-2 tw-text-white tw-bg-indigo-600 rounded-lg">
      ...
      <div class="flex flex-col flex-1">
        ...
        <div class="flex flex-1">
          ...
          <main class="flex items-center justify-center flex-1 px-4 py-8">
            <h1 class="text-5xl font-bold text-gray-500">SIMS</h1>
            <!-- Content -->
          </main>
        </div>
      </div>
