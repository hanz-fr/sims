...
<body class="tw-bg-white">
    ...
    <div class="tw-flex tw-overflow-x-hidden tw-h-screen">
        ...
        <aside class="tw-w-64 tw-top-0 tw-bottom-0 tw-sticky" aria-label="Sidebar">
            <div
                class="tw-w-64 tw-h-screen tw-sticky tw-py-4 tw-px-3 tw-bg-[#454F58] tw-justify-between tw-flex tw-flex-col">
                <div class="">
                    <a href="/manage" class="tw-items-center tw-flex tw-flex-col tw-gap-3 tw-pl-2.5 tw-mb-5 tw-mt-8">
                        ...
                        <span
                            class="tw-self-center tw-text-2xl tw-font-semibold tw-whitespace-nowrap tw-font-pop tw-text-gray-100">SIMS
                            Admin</span>
                    </a>
                    <ul class="tw-space-y-3 tw-font-ubuntu tw-mt-20">
                        <li>
                            <a href="/admin/manage"
                                class="{{ $active === 'admin' ? 'tw-bg-[#5A6C7C] tw-text-white' : '' }} nav-item-admin tw-transition-colors tw-duration-300">
               ...
               <span class="tw-ml-3 tw-font-bold tw-text-lg">Account</span>
                ...
                <div class="tw-flex tw-flex-col tw-justify-center">
                    ...
                    <div x-data="{ isActive: false, open: false }">
                        <div x-show="open" x-transition.duration.90ms
                            class="tw-my-2 tw-font-ubuntu tw-font-bold tw-justify-center tw-text-center" role="menu"
                            arial-label="Components">
                            <a href="/admin/logout" role="menuitem"
                                class="nav-item-admin tw-justify-center tw-font-bold tw-transition-colors tw-duration-200 tw-text-center">
                        ...
                        <a href="#" @click="$event.preventDefault(); open = !open"
                            ...
                            <span aria-hidden="true" class="tw-mr-3">
                                <i
                                    class="fa-light fa-circle-user tw-text-4xl group-hover:tw-text-white group-focus:tw-text-white"></i>
                            </span>
                            <span
                                class="mx-3 text-left whitespace-nowrap tw-font-pop tw-text-gray-400 font-medium group-hover:tw-text-white group-focus:tw-text-white">
                                {{ auth()->user()->name }} </span>
