        ...
        <div class="tw-flex tw-flex-col tw-bg-white tw-shadow-md tw-w-full">
            <div class="tw-mt-5 tw-mr-5">
                <div class="tw-float-right">
                    <a href="#" class="tw-text-sims-400 tw-text-2xl"><i class="fa-solid fa-pen-line"></i></a>
                </div>
            </div>
            <div class="tw-flex -tw-mt-10">
                ...
                <div class="username tw-flex tw-flex-col tw-justify-center">
                    <div class="tw-text-sims-400 tw-font-pop tw-font-bold tw-text-2xl tw-mb-2">{{ auth()->user()->nama }}</div>
                    <div class="tw-text-sims-400 tw-font-pop tw-text-xl">{{ auth()->user()->email }}</div>
                </div>
            </div>
        </div>
        {{-- detail --}}
        <div class="tw-flex tw-flex-row tw-bg-white tw-shadow-md tw-w-full tw-h-fit tw-mt-5 tw-font-pop tw-px-20">
            <div class="tw-w-3/5 tw-flex tw-flex-col">
                ...
                <div class="tw-flex tw-justify-between tw-mb-8 tw-mr-20">
                    <div class="tw-text-sims-400 tw-font-bold tw-text-base">NIP</div>
                    <div class="tw-text-sims-400 tw-font-normal tw-text-base">{{ auth()->user()->nip }}</div>
                </div>
                <div class="tw-flex tw-justify-between tw-mb-8 tw-mr-20">
                    <div class="tw-text-sims-400 tw-font-bold tw-text-base">Nomor HP</div>
                    <div class="tw-text-sims-400 tw-font-normal tw-text-base">088271872817827</div>
                </div>
            </div>
        </div>
    </div>
