            ...
            <table class="tw-w-full tw-text-sm tw-text-center">
                ...
                <tbody class="tw-text-base">
                    <tr class="tw-bg-white tw-border">
                        ...
                        <td class="tw-py-4 tw-px-6 tw-border">-</td>
                        <td>
                            <a href="" class="tw-border tw-rounded-lg text-white tw-py-2 tw-px-5 tw-bg-sims hover:tw-bg-[#3b7a7a]">
                                <i class="fa-solid fa-file-pen"></i>
                            </a>
                            <a href="" class="tw-border tw-rounded-lg text-white tw-py-2 tw-px-4 tw-bg-[#949494] hover:tw-bg-[#717171]">
