...
<body>
    ...
    <div class="tw-mx-auto tw-flex tw-justify-center tw-items-center tw-h-screen tw-container">
        <!-- card -->
        <div
            class="tw-flex lg:tw-flex-row sm:tw-flex-col-reverse tw-bg-white tw-px-20 tw-py-10 tw-mx-auto tw-w-2/3 tw-h-fit">
            <!-- form section -->
            <div class="input-area lg:tw-w-3/5 tw-mr-8 sm:tw-w-full tw-flex tw-flex-col tw-justify-center">
                ...
                <form action="{{ route('update.password') }}" method="POST" class="tw-mt-12">
                    ...
                    <ul class="tw-flex tw-flex-col tw-gap-5 tw-font-ubuntu">
                        ...
                        <li x-data="{ show: true }" class="tw-flex tw-flex-col">
                            <div class="tw-relative tw-w-full">
                                <input name="password_confirmation" id="password"
                                    ...
                                    placeholder="Ulangi Kata Sandi Baru" :type="show ? 'password' : 'text'"
                        ...
                        <li>
                            <button type="submit"
                                class="tw-bg-[#90C2C2] tw-w-full tw-py-3 tw-text-sm tw-font-medium tw-text-white hover:tw-bg-[#5B9C9C]">Change
                                Password</button>
                        </li>
                    </ul>
                </form>
            ...
            <img class="lg:tw-w-1/2 sm:tw-mb-4 sm:tw-w-full tw-items-center md:tw-m-auto tw-mr-0"
                src="{{ URL::asset('assets/img/reset-password.svg') }}" alt="" srcset="">
        </div>
    </div>
    </div> <!-- container -->
