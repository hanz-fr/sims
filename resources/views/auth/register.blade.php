            ...
            <form action="/registeruser" method="post" id="signUp" class="tw-mt-10 lg:tw-pr-8">
                ...
                <div style="display: block;">
                    <ul class="tw-flex tw-flex-col tw-gap-5">
                        ...
                        <li>
                            <input type="text" name="phone" id="number" @error('phone') is-invalid @enderror placeholder="Nomor Telepon (+62)" maxlength="20" class="login-input" required>
                            @error('phone')
                                <div class="tw-text-sm tw-text-pink-700 tw-mt-1 tw-font-ubuntu">{{ $message }}</div>
                            @enderror
                        </li>
                        ...
                        <li>
                            <button type="button" id="sign-in-button" onclick="phoneSendAuth();" class="tw-font-ubuntu tw-bg-[#90C2C2] tw-w-full tw-py-4 tw-text-sm tw-font-medium tw-text-white hover:tw-bg-[#5B9C9C]">Daftar</button>
                        </li>
