...
@if($status == 'success')
    <div class="tw-mx-auto tw-container">
        <section class="tw-bg-white tw-font-satoshi tw-rounded-[50px] tw-flex tw-flex-col tw-mx-auto tw-my-28 tw-px-20 tw-py-11 tw-top-1/2 tw-w-3/5 tw-h-3/5 tw-border tw-border-slate-200 tw-shadow-xl tw-text-center">
    ...
    <div class="tw-mx-auto tw-flex tw-justify-center tw-items-center tw-h-screen tw-container">
        ...
        <div class="tw-flex lg:tw-flex-row tw-h-fit sm:tw-flex-col-reverse tw-bg-white tw-px-20 tw-py-16 tw-mx-auto tw-w-2/3 tw-border tw-border-slate-200 tw-shadow-xl">
            ...
            <section class="lg:tw-w-3/5 lg:tw-mr-8 sm:tw-w-full">
                ...
                <div class="tw-text-sm tw-font-sg tw-mt-2 tw-text-gray-400 sm:tw-text-center lg:tw-text-left">Masuk untuk mengakses website</div>
                        ...
                        <li class="tw-flex tw-justify-between">
                            <div class="tw-flex">
                                <div class="tw-flex tw-items-center tw-h-5">
                                    <input id="remember" name="remember" type="checkbox" class="tw-w-4 tw-h-4 tw-bg-gray-50 tw-rounded tw-border tw-border-gray-500 focus:ring-3 focus:tw-ring-sims-new-500">
                                </div>
                                <label for="remember" class="tw-ml-1 tw-text-sm tw-font-medium tw-text-sims-new-500">Remember me</label>
                            </div>
                            <a href="/forgot-password" class="tw-text-sims-new-500 tw-underline tw-text-sm">Lupa Kata Sandi?</a>
                        </li>
                        <li>
