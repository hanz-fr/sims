        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Poppins', sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Halo ~! Klik untuk verifikasi akun anda^_^</p>
            </td>
          </tr>
          <!-- end copy -->
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#4d9e9e" style="border-radius: 6px;">
                          <a href="{{ route('account.verify', $user->token) }}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Poppins', sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Verifikasi Akun</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr style="margin-bottom: 30px">
            <td align="center" bgcolor="#ffffff" style="padding: 30px; font-family: 'Poppins', sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;"><a href="{{ route('account.verify', $user->token) }}" target="_blank">{{ route('account.verify', $user->token) }}</a></p>
            </td>
          </tr>
          <!-- end copy -->
