...
<div class="tw-mx-10">
    ...
    <div class="tw-grid lg:tw-grid-cols-3 md:tw-grid-cols-2 tw-gap-5 tw-mt-8 sm:tw-grid-cols-1">
        <a href="/data-induk-siswa/{{ $jurusan }}/10?page=1&perPage=10&search=">
        ...
        <a href="/data-induk-siswa/{{ $jurusan }}/11?page=1&perPage=10&search=">
        ...
        <a href="/data-induk-siswa/{{ $jurusan }}/12?page=1&perPage=10&search=">
