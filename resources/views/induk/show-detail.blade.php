            ...
            <div class="tw-flex sm:tw-flex-col md:tw-flex-row tw-font-pop">
                ...
                <div class="md:tw-w-3/5 sm:tw-w-full">
                    <div class="tw-float-right tw-flex tw-gap-2">
                        <a href="/data-siswa-print/{{ $siswa->nis_siswa }}" class="tw-bg-sims-400 tw-text-white hover:tw-text-white tw-font-pop tw-text-sm hover:tw-bg-sims-600 tw-px-5 tw-py-2 tw-rounded-lg">Print</a>
