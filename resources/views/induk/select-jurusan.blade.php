...
<div class="tw-mx-10">
    ...
    <div class="tw-grid lg:tw-grid-cols-4 md:tw-grid-cols-2 tw-gap-4 sm:tw-grid-cols-1">
        <a href="/angkatan" class="tw-flex tw-text-white tw-bg-[#1b4cff] tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-blue-700 hover:tw-text-white tw-h-36 tw-items-center">
        ...
        <a href="/angkatan" class="tw-flex tw-text-white tw-bg-[#FF5C5C] tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#c74848] hover:tw-text-white tw-h-36">
            <i class="fa-solid fa-cart-shopping tw-text-6xl tw-text tw-py-5"></i>
            <p class="tw-text-lg tw-pl-5 tw-pt-8 fw-bolder">PEMASARAN</p>
        </a>
        <a href="/angkatan" class="tw-flex tw-text-white tw-bg-[#527DB9] tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#3c5d89] hover:tw-text-white tw-h-36 tw-items-center">
        ...
        <a href="/angkatan" class="tw-flex tw-text-white tw-bg-[#BF32FC] tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#9727c6] hover:tw-text-white tw-h-36 tw-items-center">
        ...
        <a href="/angkatan" class="tw-flex tw-text-white tw-bg-[#6F6D6D] tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#585656] hover:tw-text-white tw-h-36 tw-items-center">
        ...
        <a href="/angkatan" class="tw-flex tw-text-white tw-bg-[#2CC06F] tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#249f5b] hover:tw-text-white tw-h-36 tw-items-center">
        ...
        <a href="/data-alumni" class="tw-flex tw-text-white tw-bg-sims-400 tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#3f7f7f] hover:tw-text-white tw-h-36 tw-items-center">
