...
<div class="tw-mx-10">
    ...
    <div class="tw-grid lg:tw-grid-cols-4 md:tw-grid-cols-2 tw-gap-4 sm:tw-grid-cols-1">
        ...
        <a href="/data-alumni" class="tw-flex tw-transition-all tw-ease-in tw-delay-[100] hover:-tw-translate-y-1 hover:tw-shadow-lg tw-w-full tw-text-white tw-bg-sims-400 tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-[#3f7f7f] hover:tw-text-white tw-h-36 tw-items-center">
