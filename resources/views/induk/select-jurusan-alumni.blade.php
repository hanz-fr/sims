    ...
    <div class="tw-mx-10">
        ...
        <div class="tw-grid lg:tw-grid-cols-4 md:tw-grid-cols-2 tw-gap-4 sm:tw-grid-cols-1 tw-font-satoshi tw-my-5">
            @foreach ($jurusan as $j)
                <form action="/select-angkatan-alumni">
                    <button type="submit"
                        class="tw-flex tw-transition-all tw-ease-in tw-delay-[100] hover:-tw-translate-y-1 hover:tw-shadow-lg tw-w-full tw-text-sims-new-500 tw-bg-white tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-sims-new-500 hover:tw-text-white tw-h-36 tw-items-center">
            ...
            <form action="/data-alumni/all">
                ...
                <input type="hidden" name="perPage" value="10">
                <button
                    class="tw-flex tw-transition-all tw-ease-in tw-delay-[100] hover:-tw-translate-y-1 hover:tw-shadow-lg tw-w-full tw-text-sims-new-500 tw-p-5 tw-rounded-xl tw-shadow-md hover:tw-bg-sims-new-500 hover:tw-text-white tw-h-36 tw-items-center">
                    <i class="fa-solid fa-user-graduate tw-text-6xl tw-text tw-py-5"></i>
                    <p class="tw-text-base tw-text-left tw-pl-5 tw-p-2 fw-bolder">SELURUH JURUSAN & ANGKATAN</p>
                </button>
            </form>
