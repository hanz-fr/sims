...
<div class="tw-mt-10">
    <div class="tw-flex tw-ml-8 tw-mr-7 lg:tw-flex-row sm:tw-flex-col lg:tw-justify-between lg:tw-gap-5">
        <div class="tw-flex tw-flex-col">
            ...
            <div class="sims-text-gray-sm">Jumlah : {{ $total_siswa }} siswa</div>
                ...
                @can('manage-induk')
                    <div class="tw-flex md:tw-justify-center tw-items-center md:-tw-mb-8">
                        <button type="button" data-modal-toggle="modal-print" target="__blank" title="Cetak data"><i
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                <div
                                    ...
                                    <div class="tw-p-6">
                                        ...
                                        @if (!empty($jurusan) && !empty($kelas))
                                            <form action="/data-induk-print/{{ $jurusan }}/{{ $kelas }}"
                                ...
                                @if(isset($_GET['thn_ajaran'])) <input name="thn_ajaran" value="{{ $_GET['thn_ajaran'] }}" type="hidden"> @endif
                                                ...
                                                <div class="tw-flex tw-justify-center tw-mt-3">
                                                    <button type="submit"
                                                        class="tw-text-white tw-bg-sims-new-500 hover:tw-bg-sims-new-700 focus:tw-ring-4 focus:tw-outline-none focus:tw-ring-sims-new-300 dark:focus:tw-ring-red-800 tw-font-medium tw-rounded-lg tw-text-sm tw-inline-flex tw-items-center tw-py-2.5 tw-text-center tw-mr-2 tw-px-6">Ekspor</button>
                                                </div>
                                            </form>
                                        @else
                        ...
                        <button type="button" data-modal-toggle="modal-export-excel" target="__blank"
                            title="Ekspor ke Excel"><i class="fa-solid fa-file-excel btn-export"></i></button>
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                <div
                                    ...
                                    <div class="tw-p-6">
                                        ...
                                        @if (!empty($jurusan) && !empty($kelas))
                                            <form
                                                action="/data-induk-excel/{{ $jurusan }}/{{ $kelas }}?page=@if (!empty($_GET['page'])) {{ $_GET['page'] }} @endif&perPage=100"
                                                method="" class="tw-flex tw-flex-col">
                                                <div class="tw-flex tw-justify-center tw-mb-4">
                                                    <div
                                                        class="tw-my-auto tw-text-basic-700 tw-mr-2 tw-font-normal tw-text-lg tw-font-satoshi">
                        ...
                        <button type="button" data-modal-toggle="modal-export-pdf" target="__blank"
                            title="Ekspor ke PDF"><i class="fa-solid fa-file-pdf btn-export tw-mr-0"></i></button>
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                <div
                                    ...
                                    <div class="tw-p-6">
                                        ...
                                        @if (!empty($jurusan) && !empty($kelas))
                                            <form
                                                action="/data-induk-pdf/{{ $jurusan }}/{{ $kelas }}?page=@if (!empty($_GET['page'])) {{ $_GET['page'] }} @endif&perPage=100"
                                                method="" class="tw-flex tw-flex-col">
                                                <div class="tw-flex tw-justify-center tw-mb-4">
                                                    <div
                                                        class="tw-my-auto tw-text-basic-700 tw-mr-2 tw-font-normal tw-text-lg tw-font-satoshi">
            ...
            <section
                class="tw-flex lg:tw-flex-row sm:tw-flex-col tw-justify-between sm:tw-flex-wrap sm:tw-gap-5 tw-ml-8 tw-mt-8">
                ...
                <div class="tw-flex tw-my-auto">
                    ...
                    <div id="filter-dd" class="hidden tw-z-10 tw-w-72 tw-bg-white tw-rounded tw-divide-y tw-divide-gray-100 tw-shadow-md">
                        ...
                        @endif
                            ...
                            <div class="tw-flex tw-justify-center">
                                <button type="submit"
                                    class="tw-w-full tw-rounded-lg tw-mx-3 tw-font-pop tw-text-white tw-text-sm tw-font-medium tw-mb-2 tw-py-2 tw-bg-sims-new-500 hover:tw-bg-sims-500 tw-transition-all tw-ease-in-out">Simpan</button>
                            </div>
                            </form>
                        </div>
                        <!-- end filter menu -->
                            ...
                            <div class="tw-flex tw-gap-3 tw-justify-between tw-mt-5 tw-mx-5">
                                <div class="tw-absolute tw-right-4 tw-top-2">
                                    ...
                                    <a tabindex="0" role="link" aria-label="tooltip 1"
                                        ...
                                        <div id="tooltip1" role="tooltip"
                                            ...
                                            <p class="text-xs leading-4 text-gray-600">Data Induk periodik diambil
                                                berdasarkan tanggal dibuatnya data siswa tersebut.</p>
                                        </div>
                                    </a>
                                ...
                                <div>
                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">Dari
                                        tanggal</div>
                                    <input class="input-data tw-text-xs tw-font-pop" id="dibuatTglDari"
                                ...
                                <div>
                                    ...
                                    <input class="input-data tw-text-xs tw-font-pop" id="dibuatTglKe" name="dibuatTglKe"
                                    ...
                                    <div class="tw-p-6 tw-font-sg">
                                        ...
                                        <div class="tw-gap-2 tw-grid tw-grid-cols-2">
                                            ...
                                            <div id="popup-data" tabindex="-1"
                                                ...
                                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                    <div
                                                        class="tw-relative tw-mb-5 tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100">
                                                        <button type="button"
                                                        ...
                                                        <div class="tw-px-8 tw-pb-6 tw-pt-10">
                                                            ...
                                                            <div x-data="{ files: null }" id="FileUpload" class="">
                                                                <form action="/api/siswa/import" method="post"
                                                                    enctype="multipart/form-data">
                                                                    @csrf
                                                                    <label
                                                                        class="tw-flex tw-flex-col tw-w-full tw-h-56 tw-border-4 tw-border-admin-200 tw-border-dashed tw-justify-center tw-items-center hover:tw-bg-gray-100 hover:tw-border-gray-300 tw-px-10"
                                                                        for="">
                                                                            ...
                                                                            <div class="tw-flex tw-flex-col tw-space-y-1">
                                                                                <template
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <template
                                                                                            x-if="files[index].type.includes('audio/')"><i
                                                                                        ...
                                                                                        <template
                                                                                            x-if="files[index].type.includes('image/')"><i
                                                                                                class="far fa-file-image fa-fw"></i></template>
                                                                                        <template
                                                                                            x-if="files[index].type.includes('video/')"><i
                                                                                                class="far fa-file-video fa-fw"></i></template>
                                                                                        <span
                                                                                            class="tw-font-medium tw-text-gray-400"
                                                                                            x-text="files[index].name">Uploading</span>
                                                                                        <span
                                                                                            class="tw-text-xs tw-self-end tw-text-gray-400"
                                                                        ...
                                                                        <template x-if="files === null">
                                                                            <div
                                                                                class="tw-flex tw-flex-col tw-space-y-2 tw-items-center tw-justify-center">
                                                                                <svg @click="show=false"
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    class="tw-w-8 tw-h-8 tw-text-gray-400 group-hover:tw-text-gray-600"
                                                                                ...
                                                                                <p class="tw-text-gray-700">Seret berkas anda
                                                                                    kesini atau klik di area ini.</p>
                                                                            </div>
                                                                        </template>
                                                                    </label>
                                                                    <div class="tw-grid tw-gap-3 tw-mt-3">
                                                                        <a href="/siswa/download"
                                                                            class="tw-w-full tw-px-5 tw-py-2 tw-text-center tw-text-white tw-bg-ijo-400 hover:tw-bg-ijo-500 hover:tw-text-white tw-rounded tw-shadow-xl">Unduh
                                                                            Format File Import (.xlsx)</a>
                                                                        <button type="submit"
                                                                            class="tw-w-full tw-px-5 tw-py-2 tw-text-white tw-bg-sims-new-500 hover:tw-bg-sims-300 tw-rounded tw-shadow-xl">Import</button>
                                                                        <button type="button" data-modal-toggle="popup-data"
                                                                            class="tw-w-full tw-px-5 tw-py-2 tw-text-white tw-bg-gray-500 hover:tw-bg-gray-400 tw-rounded tw-shadow-xl">Batal</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
                            ...
                            @foreach ($siswa as $s)
                                <tr class="tw-bg-white">
                                    ...
                                    <td class="tw-flex tw-justify-center tw-gap-3 tw-py-2">
                                        @cannot('kesiswaan')
                                            <a href="/rekap-nilai/{{ $s->nis_siswa }}"
                                                class="tw-text-sims-new-500 tw-justify-center tw-items-center  hover:tw-text-white hover:tw-bg-sims-new-500 hover:tw-shadow-md tw-rounded-lg tw-text-xl tw-py-2 tw-px-3 tw-w-12 tw-transition-all"
                                                title="Rekap Nilai">
                                                <i class="fa-regular fa-clipboard"></i>
                                            </a>
                                        @endcannot
                                        @can('manage-induk')
                                            <a href="/edit-siswa/{{ $s->nis_siswa }}"
                                                class="tw-text-kuning-500  hover:tw-text-white hover:tw-bg-kuning-500 hover:tw-shadow-md tw-rounded-lg tw-text-xl tw-py-2 tw-px-3 tw-w-12 tw-transition-all"
                                                title="Edit Data Siswa">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                        @endcan
                                        <a href="/detail/{{ $s->nis_siswa }}"
