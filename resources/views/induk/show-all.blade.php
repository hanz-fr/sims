                    ...
                    <div class="tw-relative tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100 tw-font-satoshi">
                        ...
                        <div class="tw-p-6">
                            ...
                            <form action="/data-induk-excel/{{ $jurusan }}/{{ $kelas }}?page=@if(!empty($_GET['page'])){{ $_GET['page'] }}@endif&perPage=100" method="" class="tw-flex tw-flex-col">
                                ...
                                <div class="tw-flex tw-justify-center tw-mt-3">
                                    <button type="submit" class="tw-text-white tw-bg-sims-new-500 hover:tw-bg-sims-new-700 focus:tw-ring-4 focus:tw-outline-none focus:tw-ring-sims-new-600 tw-font-medium tw-rounded-lg tw-text-sm tw-inline-flex tw-items-center tw-py-2.5 tw-text-center tw-mr-2 tw-px-6">Ekspor</button>
                                </div>
                            </form>
                            @else
            ...
            <div class="tw-flex lg:tw-flex-row sm:tw-flex-col tw-my-auto">
                ...
                <form action="/data-induk-siswa/{{ $jurusan }}/{{ $kelas }}"> 
                    ...
                    <div class="relative tw-border-[1.5px] tw-border-gray-300 tw-rounded-xl focus:tw-ring-sims-new-500">
                        ...
                        @if(isset($_GET['angkatan']))<input name="angkatan" type="hidden" value="{{ $_GET['angkatan'] }}">@endif
                ...
                <div class="tw-flex tw-my-auto">
                    ...
                    <div id="filter-dd" class="hidden tw-z-10 tw-w-72 tw-bg-white tw-rounded tw-divide-y tw-divide-gray-100 tw-shadow-md">
                        ...
                        @if( ! empty($jurusan) && ! empty($kelas))
                        <form action="/data-induk-siswa/{{ $jurusan }}/{{ $kelas }}">
                            @if(!empty($_GET['angkatan']))<input name="angkatan" type="hidden" value="{{ $_GET['angkatan'] }}">@endif    
                            @if(isset($_GET['rombel'])) <input name="rombel" type="hidden" value="{{ $_GET['rombel'] }}"> @endif
                        @else
                        <form action="/data-induk-siswa">
                        @endif
        ...
        <div class="tw-flex tw-justify-center tw-rounded-b-lg">
            ...
            <div class="tw-py-3 tw-my-auto tw-h-min tw-flex tw-justify-center">
                <form action="/data-induk-siswa/{{ $jurusan }}/{{ $kelas }}" class="tw-text-center">
                    ...
                    <input name="rombel" value="{{ $_GET['rombel'] }}" type="hidden"> 
                    @endif
