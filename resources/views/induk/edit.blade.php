        ...
        <form method="POST" action="/api/siswa/update/{{ $siswa->nis_siswa }}" enctype="multipart/form-data"  
         ...
         {{-- PREV URL --}}
          ...
          <div x-show.transition.in="step === 1" x-transition:enter.duration.300ms>
            <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-mb-8 tw-mt-20 tw-text-sims-new-500">A.  Biodata Peserta Didik</div>
            ...
            <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                <div class="tw-w-full tw-px-3">
                    ...
                    <input class="input-data-minimal" id="thn_ajaran" type="text" name="thn_ajaran" value="{{ $siswa->thn_ajaran }}">
                </div>
            </div>
            <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                <div class="tw-w-full tw-px-3">
                    ...
                    <input class="input-data-minimal" id="angkatan" type="number" name="angkatan" value="{{ $siswa->angkatan }}">
                </div>
            </div>
            ...
            <div x-show.transition.in="step === 2" x-transition:enter.duration.300ms>
                ...
                {{-- orang tua --}}
                <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-my-8 tw-mt-20 tw-text-sims-new-500">F.  Data Orang Tua</div>
                <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                        <div class="tw-w-full tw-px-3">
                ...
                {{-- wali --}}
                <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-my-8 tw-text-sims-new-500">F.  Data Wali</div>
                <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                        <div class="tw-w-full tw-px-3">
            ...
            <div x-show.transition.in="step === 3" x-transition:enter.duration.300ms>
                ...
                <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-mb-8 tw-mt-20 tw-text-sims-new-500">G.  Meninggalkan Sekolah</div>
                <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                    <div class="tw-w-full tw-px-3">
                ...
                <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-mb-8 tw-mt-20 tw-text-sims-new-500">H.  Tamat di Sekolah ini</div>
                <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                    <div class="tw-w-full tw-px-3">
                ...
                <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-mb-8 tw-mt-20 tw-text-sims-new-500">I.  Keterangan Jasmani dan Kesehatan Siswa</div>
                <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                    <div class="tw-w-full tw-px-3">
