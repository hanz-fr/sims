...
@section('content')
  ...
  @endif --}}
        ...
        <div x-data="{
            ...
            <a href="{{ url()->previous() }}" class="tw-text-sims-new-500 tw-text-3xl tw-w-min hover:tw-text-sims-new-600"><i
            ...
            <form method="POST" action="/api/siswa" enctype="multipart/form-data"
                ...
                <div x-show.transition.in="step === 1" x-transition:enter.duration.300ms>
                    ...
                    <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-my-8 tw-text-sims-new-500 tw-mt-24">A.
                            ...
                            <select class="input-data-minimal" id="status" @error('status') is-invalid @enderror
                                ...
                                @if (old('status'))
                                    <option value="{{ old('status') }}">
                                        @if (old('status') == 'AK')
                                            Anak Kandung
                                        @elseif(old('status') == 'AA')
                                            Anak Angkat
                                        @elseif(old('status') == 'AT')
                                            Anak Tiri
                                        @endif
                                    </option>
                                @endif
                    ...
                    <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                        ...
                        <div class="tw-w-full md:tw-w-1/2 tw-px-3">
                            ...
                            <input value="{{ old('email') }}" class="input-data-minimal" id="email" type="email"
                                name="email">
                        </div>
                    </div>
                ...
                <div x-show.transition.in="step === 2" x-transition:enter.duration.300ms>
                    ...
                    {{-- data orang tua --}}
                    <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-my-8 tw-text-sims-new-500 tw-mt-24">F. Data
                        Orang Tua</div>
                    <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                        <div class="tw-w-full tw-px-3">
                    ...
                    {{-- wali --}}
                    <div class="tw-font-satoshi tw-text-2xl tw-font-semibold tw-my-8 tw-text-sims-new-500 tw-mt-20">G. Data
                        Wali</div>
                    <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                        <div class="tw-w-full tw-px-3">
                    ...
                    <div class="tw-flex tw-flex-wrap tw--mx-3 tw-mb-6">
                        <div class="tw-w-full tw-px-3">
                            ...
                            <input class="input-data-minimal" id="pekerjaan_wali_2" type="text"
                                name="pekerjaan_wali">
                        </div>
                    </div>
