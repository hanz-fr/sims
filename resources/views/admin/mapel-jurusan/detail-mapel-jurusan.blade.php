...
<div class="tw-flex tw-flex-col tw-my-10 tw-mx-10">
    <div class="tw-my-10 tw-mx">
        <h4 class="sims-heading-3xl">Detail Mata Pelajaran Jurusan</h4>
    </div>
    ...
    <div class="tw-flex tw-flex-col tw-gap-10 tw-my-10">
        <div class="tw-flex tw-justify-start tw-gap-24">
            <div class="tw-flex tw-flex-col">
                <div class="sims-text-gray-sm">Id Mata Pelajaran Jurusan</div>
                <div class="sims-heading-xl-black">{{ $mapel_jurusan->mapelJurusanId }}</div>
            </div>
