...
@section('content')
    <div class="tw-flex tw-flex-col tw-my-10">
        ...
        <div class="sims-heading-2xl tw-flex tw-justify-center">Create Mata Pelajaran</div>
        ...
        <div class="tw-flex tw-justify-center">
            ...
            <form action="/admin/mata-pelajaran/store" method="POST" class="tw-flex tw-flex-col tw-gap-8 tw-w-1/4">
                @csrf
                @method('POST')
                    ...
                    <div class="tw-flex tw-gap-3">
                        ...
                        <a tabindex="0" role="link" aria-label="tooltip 1"
                            ...
                            <div id="tooltip1" role="tooltip"
                                class="z-20 tw-w-64 absolute transition duration-150 ease-in-out tw-right-0 tw-left-8 tw-bottom-0 ml-8 shadow-lg bg-white p-4 rounded hidden">
                                <p class="tw-text-sm tw-font-satoshi tw-font-bold text-gray-600">Id Mata Pelajaran</p>
                                <p class="tw-text-sm tw-font-satoshi tw-font-normal leading-4 text-gray-600">merupakan singkatan dari mata pelajaran. (Contoh: PBO => Pemrograman Berorientasi Objek)</p>
                            </div>
                        </a>
                    <!--Code Block for white tooltip ends-->
                    </div>
                    <input required name="id" class="tw-border-[1.5px] tw-transition-all tw-duration-500 tw-ease-out tw-font-satoshi tw-font-normal tw-text-gray-500 tw-border-gray-300 tw-py-1 tw-px-5 tw-rounded-xl focus:tw-outline-sims-new-500">
                </div>
                <div class="tw-flex tw-flex-col tw-gap-1">
                ...
                <div class="tw-flex tw-justify-end">
                    <button type="submit" class="tw-bg-sims-new-500 tw-transition-all tw-w-fit tw-text-white hover:tw-text-white hover:tw-bg-sims-new-700 tw-font-satoshi tw-transition-all tw-rounded-lg tw-px-8 tw-py-2"> Create </button>
                </div>
            </form>
