...
<div class="tw-mt-10">
    <div class="tw-flex tw-flex-col tw-mt-8 tw-ml-8">
        <h4 class="sims-heading-3xl">Data Mata Pelajaran</h4>
        <div class="sims-text-gray-sm">Total : {{ $total_mapel }}</div>
    </div>
        ...
        <div class="tw-flex tw-justify-between tw-ml-8 tw-mt-8 lg:tw-flex-row sm:tw-flex-col sm:tw-gap-5">
            <div class="tw-flex tw-my-auto">
                ...
                <!-- Searching -->
                <form action="/admin/mata-pelajaran"> 
                ...
                <tbody class="tw-text-base">
                    ...
                    <tr class="tw-bg-white">
                        ...
                        <td class="tw-flex tw-mt-8 tw-justify-center tw-gap-3">
                          <a href="/admin/mata-pelajaran/edit/{{ $m->id }}" class="tw-text-kuning-500  hover:tw-text-white hover:tw-bg-kuning-500 hover:tw-shadow-md tw-rounded-lg tw-text-xl tw-py-2 tw-px-3 tw-w-12 tw-transition-all" title="Edit Data">
                              <i class="fa-solid fa-pen-to-square"></i>
                          </a>
                          <a href="/admin/detail-mata-pelajaran/{{ $m->id }}" class="tw-text-gray-400  hover:tw-text-white hover:tw-bg-gray-400 hover:tw-shadow-md tw-rounded-lg tw-text-xl tw-py-2 tw-px-3 tw-w-12 tw-transition-all" title="Lihat Detail Data">
        ...
        <div class="tw-flex tw-justify-center tw-rounded-b-lg">
            ...
            <div class="tw-py-3 tw-my-auto tw-h-min tw-flex tw-justify-center">
                <form action="/admin/mata-pelajaran" class="tw-text-center">
