    ...
    <div class="tw-flex tw-flex-col tw-ml-8 tw-mt-14">
        ...
        <div class="tw-float-right tw-mr-8 tw-flex tw-flex-col">
            <form action="/admin/account/{{ $user->id }}" method="POST" class="tw-float-right tw-text-right tw-mb-5 -tw-mt-20">
                ...
                <button type="button" data-modal-toggle="popup-modal" class="tw-bg-red-400 tw-w-fit tw-px-4 tw-py-2 tw-rounded-xl tw-text-base tw-text-white tw-font-satoshi"><i class="fa-regular fa-trash-can tw-text-lg tw-mr-2"></i>Hapus Akun</button>
