              ...
              <tr class="tw-bg-white">
                ...
                <td class="tw-p-6 tw-justify-center">
                    @if ($u->email_verified_at)
                        <span class="tw-w-fit tw-text-xs tw-py-1 tw-px-4 tw-text-center tw-whitespace-nowrap tw-items-center tw-justify-center tw-font-bold tw-bg-ijo-400 tw-text-white tw-rounded-full">Terverifikasi</span>                    
                    @else
                ...
                <td class="tw-p-6">@if(!empty($createdAt)) {{ $created_at }} @endif</td>
