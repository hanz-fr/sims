            ...
            <form action="/admin/account/{{ $user->id }}" method="POST">
                ...
                <div class="tw-flex tw-flex-col tw-space-y-6">
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ $user->nip }}" @error('nip') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="nip" name="nip" type="text" maxlength="10"
                            required>
                        @error('nip')
                    ...
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ $user->nama }}" @error('nama') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="nama" name="nama" type="text" required>
                        @error('nama')
                            <small class="tw-text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ $user->email }}" @error('email') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="email" name="email" type="email">
                        @error('email')
                            <small class="tw-text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ $user->no_telp }}" @error('no_telp') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="no_telp" name="no_telp" type="text">
                        @error('no_telp')
                            <small class="tw-text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <select value="{{ $user->role }}" class="input-data-minimal" id="nip" name="role"
                            type="text">
                    ...
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <select value="{{ $user->is_admin }}" class="input-data-minimal" id="status" name="is_admin"
                            required>
                    ...
                    <div class="tw-mx-auto tw-text-center tw-mt-10">
                        <button type="submit"
                            class="tw-bg-sims-new-500 tw-font-sg tw-font-medium tw-transition hover:tw-bg-sims-new-600 tw-text-white tw-py-3 tw-px-6 tw-rounded-lg">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
