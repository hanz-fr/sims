        ...
        {{-- <input type="hidden" name="prevURL" id="prevURL" value="{{ $prevURL }}"> --}}
          ...
          <div class="tw-flex tw-flex-col tw-space-y-6">
              ...
              <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                  ...
                  <input @error('nama_siswa') is-invalid @enderror class="input-data-minimal tw-w-full" id="nama_siswa" name="nama_siswa" type="text" required>
                  @error('nama_siswa')
                      <small class="tw-text-red-500">{{ $message }}</small>
                  @enderror
              </div>
              <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                ...
                <input @error('alasan_mutasi') is-invalid @enderror class="input-data-minimal tw-w-full" id="alasan_mutasi" name="alasan_mutasi" type="text">
                @error('alasan_mutasi')
                    <small class="tw-text-red-500">{{ $message }}</small>
                @enderror
            </div>
