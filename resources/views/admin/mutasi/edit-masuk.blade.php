...
<div class="tw-mx-10 tw-w-screen tw-h-screen">
  <div class="tw-flex tw-flex-col tw-mt-8 tw-gap-8">
    ...
    <form action="" method="POST">
      @csrf
    <section class="tw-bg-white tw-rounded-xl tw-border-b-[17px] tw-border-oren-300 tw-py-20 tw-pl-10 tw-font-pop shadow-cs">
          ...
          <div class="md:tw-px-24 sm:tw-px-5 tw-w-full">
            <div class="tw-flex tw-flex-wrap tw-justify-between tw-w-full tw-mb-6">
              <div class="md:tw-w-1/2 sm:tw-w-full tw-pr-10 tw-mb-6 md:tw-mb-0 tw-font-ubuntu">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3 tw-text-lg" for="nama">
                  Nama
                </label>
              ...
              <div class="md:tw-w-1/2 sm:tw-w-full tw-px-3 tw-mb-6 md:tw-mb-0 tw-font-ubuntu">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3 tw-text-lg" for="tgl_keluar">
                  Tanggal Masuk
                </label>
            ...
            <div class="tw-flex tw-flex-wrap tw-justify-between tw-w-full tw-mb-6">
              <div class="md:tw-w-1/2 sm:tw-w-full tw-pr-10 tw-mb-6 md:tw-mb-0 tw-font-ubuntu tw-text-lg">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3" for="nis_siswa">
                  Nomor Induk
                </label>
                <input value="" class="input-account" id="nis_siswa" name="nis_siswa" type="number" required>
              </div>
              <div class="md:tw-w-1/2 sm:tw-w-full tw-px-3 tw-mb-6 md:tw-mb-0 tw-font-ubuntu">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3 tw-text-lg" for="sk_mutasi">
                  SK Mutasi
                </label>
            ...
            <div class="tw-flex tw-flex-wrap tw-justify-between tw-w-full tw-mb-6">
              <div class="md:tw-w-1/2 sm:tw-w-full tw-pr-10 tw-mb-6 md:tw-mb-0 tw-font-ubuntu tw-text-lg">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3 tw-text-lg" for="gender">
                  Gender
                </label>
              ...
              <div class="md:tw-w-1/2 sm:tw-w-full tw-px-3 tw-mb-6 md:tw-mb-0 tw-font-ubuntu">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3 tw-text-lg" for="pindah_dari">
                  Pindah dari
                </label>
            ...
            <div class="tw-flex tw-flex-wrap tw-justify-between tw-w-full tw-mb-6">
              <div class="md:tw-w-1/2 sm:tw-w-full tw-pr-10 tw-mb-6 md:tw-mb-0 tw-font-ubuntu tw-text-lg">
                <label class="tw-text-oren-400 tw-font-bold tw-ml-3 tw-text-lg" for="id_kelas">
                  Diterima di Kelas
                </label>
                <select value="" class="input-account" id="id_kelas" name="id_kelas" required>
                  <option value="1">X RPL 2</option>
