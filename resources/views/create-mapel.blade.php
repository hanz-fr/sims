...
@section('content')
    <div class="tw-mx-10 tw-w-screen">
        <div class="tw-flex tw-mt-8">
            <div class="tw-text-2xl tw-font-pop tw-font-semibold tw-text-gray-300">Tambah Mata Pelajaran</div>
        </div>
        <div
            class="tw-flex tw-justify-center tw-flex-col tw-bg-white shadow-cs tw-py-8 tw-px-16 tw-rounded-xl tw-w-full tw-mb-8 tw-mt-10">
            <form action="">
                <div class="tw-font-ubuntu tw-flex-col tw-justify-center">
                    ...
                    <input type="text" id="id" name="id"
                        class="tw-flex tw-border tw-w-full tw-border-admin-300 tw-rounded-2xl tw-py-3">
                </div>
                ...
                <div class="tw-font-ubuntu tw-flex-col tw-mt-12 tw-justify-center">
