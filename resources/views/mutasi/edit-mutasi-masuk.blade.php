    ...
    @else
        <div class="tw-flex tw-justify-center">
            ...
            <div
                ...
                <h3 class="tw-font-pop tw-font-semibold tw-mt-6 tw-text-sims-new-500 tw-text-center tw-mb-14">Edit Data
                    Mutasi Masuk</h3>
                    ...
                    <div class="tw-flex tw-flex-col tw-space-y-6">
                        ...
                        <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                            ...
                            <select class="input-data-minimal" id="diterima_di_kelas" name="diterima_di_kelas">
                                <option selected value="{{ $mutasi->diterima_di_kelas }}">{{ $mutasi->diterima_di_kelas }}
                                </option>
                                @foreach ($kelas as $k)
