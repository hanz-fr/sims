    ...
    @else
        <div class="tw-mt-10">
            <div class="tw-flex lg:tw-flex-row sm:tw-flex-col tw-ml-8 tw-mr-7 tw-justify-between tw-mt-8">
                <div class="tw-flex">
                    <h4 class="sims-heading-3xl">Data Mutasi Keluar</h4>
                </div>
                                            ...
                                            <div class="tw-flex tw-gap-3 tw-justify-between tw-mt-5 tw-mx-5">
                                                <div>
                                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">
                                                        Dari tanggal</div>
                                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_keluar_dari"
                                                        name="tgl_keluar_dari" type="date" placeholder="dd/mm/yyyy"
                                                        @if (isset($_GET['tgl_keluar_dari'])) value="{{ $_GET['tgl_keluar_dari'] }}" @endif>
                                                </div>
                                                <div>
                                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">
                                                        Ke tanggal</div>
                                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_keluar_ke"
                                                        name="tgl_keluar_ke" type="date" placeholder="dd/mm/yyyy"
                                                        @if (isset($_GET['tgl_keluar_ke'])) value="{{ $_GET['tgl_keluar_ke'] }}" @endif>
                                                </div>
                                            </div>
                ...
                <div class="tw-flex tw-my-auto">
                    <form action="/siswa-keluar">
                        <div class="relative tw-border-[1.5px] tw-border-gray-300 tw-rounded-xl">
                            ...
                            @endif
                            @if (isset($_GET['keluar_di_kelas']))
                                <input name="keluar_di_kelas" value="{{ $_GET['keluar_di_kelas'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['tgl_mutasi']))
                                <input name="tgl_mutasi" value="{{ $_GET['tgl_mutasi'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['sk_mutasi']))
                                <input name="sk_mutasi" value="{{ $_GET['sk_mutasi'] }}" type="hidden">
                            @endif
                            ...
                            @endif
                            @if (isset($_GET['tgl_keluar_dari']))
                                <input name="tgl_keluar_dari" value="{{ $_GET['tgl_keluar_dari'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['tgl_keluar_ke']))
                                <input name="tgl_keluar_ke" value="{{ $_GET['tgl_keluar_ke'] }}" type="hidden">
                            @endif
                            ...
                            <ul class="tw-p-3 tw-space-y-1 tw-text-sm tw-text-gray-700"
                                ...
                                <li>
                                    <div
                                        ...
                                        <label
                                            ...
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Nomor
                                                Induk</span>
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="keluar_di_kelas"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['keluar_di_kelas']) @if ($_GET['keluar_di_kelas'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Keluar
                                                di Kelas</span>
                                        </label>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="sk_mutasi"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['sk_mutasi']) @if ($_GET['sk_mutasi'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">SK
                                                Mutasi</span>
                                        </label>
                                    </div>
                                </li>
                                ...
                                <div class="tw-absolute tw-right-4 tw-top-2">
                                    ...
                                    <a tabindex="0" role="link" aria-label="tooltip 1"
                                        ...
                                        <div id="tooltip1" role="tooltip"
                                            ...
                                            <p class="text-xs leading-4 text-gray-600">Data mutasi keluar periodik diambil
                                                berdasarkan tanggal keluar siswa tersebut. </p>
                                        </div>
                                    </a>
                    ...
                    <table class="tw-w-full tw-text-lg tw-text-center tw-font-satoshi tw-text-bluewood-900">
                        <thead class="tw-border-y">
                            <tr>
                                ...
                                <th scope="col" class="tw-py-5 tw-px-6">Keluar di Kelas</th>
                                <th scope="col" class="tw-py-5 tw-px-6">Tanggal Keluar</th>
                                <th scope="col" class="tw-py-5 tw-px-6">SK Mutasi</th>
                        ...
                        <tbody class="tw-text-base">
                            @foreach ($mutasi as $m)
                                <tr class="tw-bg-white">
                                    <td class="counterCell tw-py-4 tw-px-6"></td>
                                    <td class="tw-p-6">{{ $m->nama_siswa }}</td>
                                    <td class="tw-p-6">{{ $m->nis_siswa }}</td>
                                    <td class="tw-p-6">{{ $m->keluar_di_kelas }}</td>
                                    <td class="tw-p-6">{{ $m->tgl_mutasi }}</td>
                                    <td class="tw-p-6">{{ $m->sk_mutasi }}</td>
                                    <td class="tw-p-6">{{ $m->alasan_mutasi }}</td>
