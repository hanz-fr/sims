...
@section('content')
    <div class="tw-flex tw-justify-center">
                        ...
                        <div class="tw-relative tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100">
                            <div class="tw-p-6">
                                <svg aria-hidden="true"
                                    class="tw-mx-auto tw-mb-4 tw-w-14 tw-h-14 tw-text-red-400 dark:tw-text-red-400"
                                ...
                                <div
                                    ...
                                    {{ session('error-mutasi') }}</div>
                                <div class="tw-flex tw-justify-center">
                                    <button onclick="hidemodal();" id="okbtn" type="button"
        ...
        <div
            ...
            <h3 class="tw-font-satoshi tw-font-semibold tw-mt-6 tw-mb-14 tw-text-sims-new-500 tw-text-center">Tambah Data
                Mutasi Keluar</h3>
            <form action="/api/mutasi-keluar/store" method="POST">
                ...
                <div class="tw-flex tw-flex-col tw-space-y-6">
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input list="browsers" value="{{ old('nis_siswa') }}" @error('nis_siswa') is-invalid @enderror
                    ...
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ old('alasan_mutasi') }}" @error('alasan_mutasi') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="alasan_mutasi" name="alasan_mutasi" type="text">
                        @error('alasan_mutasi')
                            <small class="tw-text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ old('pindah_ke') }}" @error('pindah_ke') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="pindah_ke" name="pindah_ke" type="text">
                        @error('pindah_ke')
                            <small class="tw-text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ old('tgl_mutasi') }}" @error('tgl_mutasi') is-invalid @enderror
                    ...
                    <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                        ...
                        <input value="{{ old('sk_mutasi') }}" @error('sk_mutasi') is-invalid @enderror
                            class="input-data-minimal tw-w-full" id="sk_mutasi" name="sk_mutasi" type="text">
                        @error('sk_mutasi')
                            <small class="tw-text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="tw-mx-auto tw-text-center tw-mt-10">
                        <button type="submit"
                            class="tw-bg-sims-new-500 tw-font-sg tw-font-medium tw-transition hover:tw-bg-sims-new-600 tw-text-white tw-py-3 tw-px-6 tw-rounded-lg">Kirim</button>
                    </div>
                </div>
            </form>
        </div>
