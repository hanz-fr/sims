...
@section('content')
    ...
    @if ($status == 'error')
        <div class="tw-flex tw-justify-center">
            <div class="tw-block tw-my-32">
                ...
                <h1 class="tw-flex tw-justify-center tw-font-pop tw-font-bold tw-mt-6 tw-text-sims-new-500">404 Not Found
                </h1>
    ...
    @else
        <div class="tw-mt-10">
            <div class="tw-flex lg:tw-flex-row sm:tw-flex-col tw-ml-8 tw-mr-7 tw-justify-between tw-mt-8">
                ...
                @can('manage-alumni')
                    <div class="tw-flex md:tw-justify-center tw-items-center">
                            ...
                            <div class="tw-relative tw-p-4 tw-w-full tw-max-w-md tw-h-full md:tw-h-auto">
                                <div class="tw-relative tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100">
                                    ...
                                    <form action="/mutasi-masuk-print" target="__blank" method="">
                                        ...
                                        <div class="tw-p-6">
                                            <div
                                                class="tw-text-gray-400 tw-font-pop tw-text-center tw-font-semibold tw-text-lg">
                                                Cetak Data</div>
                                            <div class="tw-flex tw-gap-3 tw-justify-between tw-mt-5 tw-mx-5">
                                                <div>
                                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">
                                                        Dari tanggal</div>
                                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_masuk_dari"
                                                        name="tgl_masuk_dari" type="date" placeholder="dd/mm/yyyy"
                                                        @if (isset($_GET['tgl_masuk_dari'])) value="{{ $_GET['tgl_masuk_dari'] }}" @endif>
                                                </div>
                                                <div>
                                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">
                                                        Ke tanggal</div>
                                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_masuk_ke"
                                                        name="tgl_masuk_ke" type="date" placeholder="dd/mm/yyyy"
                                                        @if (isset($_GET['tgl_masuk_ke'])) value="{{ $_GET['tgl_masuk_ke'] }}" @endif>
                                                </div>
                                            </div>
                                            <div class="tw-flex tw-justify-center tw-mt-5">
                                                <button type="submit" target="__blank"
                                                    class="tw-w-full tw-rounded-lg tw-mx-3 tw-font-pop tw-text-white tw-text-sm tw-font-medium tw-mb-2 tw-py-2 tw-bg-sims-new-500 hover:tw-bg-sims-new-600 tw-transition-all tw-ease-in-out">Cetak</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="tw-relative tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100">
                                    ...
                                    <form action="/mutasi-masuk-excel" method="">
                                        ...
                                        <div class="tw-p-6">
                                            ...
                                            <div class="tw-flex tw-justify-center tw-mt-5">
                                                <button type="submit"
                                                    class="tw-w-full tw-rounded-lg tw-mx-3 tw-font-pop tw-text-white tw-text-sm tw-font-medium tw-mb-2 tw-py-2 tw-bg-sims-new-500 hover:tw-bg-sims-new-600 tw-transition-all tw-ease-in-out">Ekspor</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <button type="button" data-modal-toggle="export-pdf" title="Export ke PDF"><i
                                class="fa-solid fa-file-pdf btn-export tw-mr-0"></i></button>
                                    ...
                                    <form action="/mutasi-masuk-pdf">
                                        ...
                                        <div class="tw-p-6">
                                            ...
                                            <div class="tw-flex tw-gap-3 tw-justify-between tw-mt-5 tw-mx-5">
                                                <div>
                                                    <div
                                                        class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">
                                                        Dari tanggal</div>
                                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_masuk_dari"
                                                        name="tgl_masuk_dari" type="date" placeholder="dd/mm/yyyy"
                                                        @if (isset($_GET['tgl_masuk_dari'])) value="{{ $_GET['tgl_masuk_dari'] }}" @endif>
            ...
            <div class="tw-flex tw-justify-between lg:tw-flex-row sm:tw-flex-col sm:tw-gap-5 tw-ml-8 tw-mt-8">
                <div class="tw-flex tw-my-auto">
                    <form action="/siswa-masuk">
                        <div
                            ...
                            @endif
                            @if (isset($_GET['tgl_mutasi']))
                                <input name="tgl_mutasi" value="{{ $_GET['tgl_mutasi'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['diterima_di_kelas']))
                                <input name="diterima_di_kelas" value="{{ $_GET['diterima_di_kelas'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['pindah_dari']))
                                <input name="pindah_dari" value="{{ $_GET['pindah_dari'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['alasan_mutasi']))
                                <input name="alasan_mutasi" value="{{ $_GET['alasan_mutasi'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['tgl_masuk_dari']))
                                <input name="tgl_masuk_dari" value="{{ $_GET['tgl_masuk_dari'] }}" type="hidden">
                            @endif
                            @if (isset($_GET['tgl_masuk_ke']))
                                <input name="tgl_masuk_ke" value="{{ $_GET['tgl_masuk_ke'] }}" type="hidden">
                            @endif
                            ...
                            <ul class="tw-p-3 tw-space-y-1 tw-text-sm tw-text-gray-700"
                                ...
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="tgl_mutasi"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['tgl_mutasi']) @if ($_GET['tgl_mutasi'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Tanggal
                                                Masuk</span>
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="diterima_di_kelas"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['diterima_di_kelas']) @if ($_GET['diterima_di_kelas'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Diterima
                                                di Kelas</span>
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="pindah_dari"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['pindah_dari']) @if ($_GET['pindah_dari'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Pindah
                                                dari</span>
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="alasan_mutasi"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['alasan_mutasi']) @if ($_GET['alasan_mutasi'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Alasan</span>
                                        </label>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div id="periodik-dd"
                        ...
                        <form action="/siswa-masuk" class="tw-text-center">
                            ...
                            <div class="tw-flex tw-gap-3 tw-justify-between tw-mt-5 tw-mx-5">
                                    ...
                                    <a tabindex="0" role="link" aria-label="tooltip 1"
                                        ...
                                        <div class=" cursor-pointer">
                                            <i data-tooltip-target="tooltip-animation"
                                                class="fa-regular fa-circle-question tw-text-md tw-text-sims-new-500"></i>
                                        </div>
                                        <div id="tooltip1" role="tooltip"
                                            class="z-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-white p-4 rounded hidden">
                                            <p class="text-sm font-bold text-gray-800 pb-1">Data periodik Mutasi Masuk</p>
                                            <p class="text-xs leading-4 text-gray-600">Data mutasi masuk periodik diambil
                                                berdasarkan tanggal masuk siswa tersebut.</p>
                                        </div>
                                    </a>
                                    <!--Code Block for white tooltip ends-->
                                </div>
                                <div>
                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">Dari
                                        tanggal</div>
                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_masuk_dari"
                                        name="tgl_masuk_dari" type="date" placeholder="dd/mm/yyyy"
                                        @if (isset($_GET['tgl_masuk_dari'])) value="{{ $_GET['tgl_masuk_dari'] }}" @endif>
                                ...
                                <div>
                                    <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">Ke tanggal
                                    </div>
                                    <input class="input-data tw-text-xs tw-font-pop" id="tgl_masuk_ke"
                                        name="tgl_masuk_ke" type="date" placeholder="dd/mm/yyyy"
                                        @if (isset($_GET['tgl_masuk_ke'])) value="{{ $_GET['tgl_masuk_ke'] }}" @endif>
            ...
            @if (isset($mutasi))
                    ...
                    <table class="tw-w-full tw-text-lg tw-text-center tw-font-satoshi tw-text-bluewood-900">
                        <thead class="tw-border-y">
                            <tr>
                                ...
                                <th scope="col" class="tw-py-5 tw-px-6">Nomor Induk</th>
                                <th scope="col" class="tw-py-5 tw-px-6">Gender</th>
                                <th scope="col" class="tw-py-5 tw-px-6">Tanggal Masuk</th>
                                <th scope="col" class="tw-py-5 tw-px-6">Diterima di Kelas</th>
                                <th scope="col" class="tw-py-5 tw-px-6">Pindah Dari/Alasan</th>
                        ...
                        <tbody class="tw-text-base">
                            @foreach ($mutasi as $m)
                                <tr class="tw-bg-white">
                                    <td class="counterCell tw-py-4 tw-p-6"></td>
                                    <td class="tw-p-6">{{ $m->nama_siswa }}</td>
                                    <td class="tw-p-6">{{ $m->nis_siswa }}</td>
                                    <td class="tw-p-6">{{ $m->jenis_kelamin }}</td>
                                    <td class="tw-p-6">{{ $m->tgl_mutasi }}</td>
                                                    ...
                                                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="tw-absolute tw-top-3 tw-right-2.5 tw-text-gray-400 tw-bg-transparent hover:tw-bg-gray-200 hover:tw-text-gray-900 tw-rounded-lg tw-text-sm tw-p-1.5 tw-ml-auto tw-inline-flex tw-items-center dark:hover:tw-bg-gray-800 dark:hover:tw-text-white"
                                                                data-modal-toggle="popup-modal_{{ $m->id }}">
                                                                <svg aria-hidden="true" class="tw-w-5 tw-h-5"
                ...
                <div class="tw-flex tw-justify-center tw-rounded-b-lg">
                    ...
                    @else
                        <div class="tw-float-right tw-py-5">
                            <a
                                class="tw-text-sims-new-700 hover:tw-text-sims-new-700 tw-rounded-lg tw-text-xl tw-py-2 tw-px-3"><i
                                    class="fa-solid fa-chevron-left"></i></a>
                        </div>
                    @endif
                    ...
                    <div class="tw-py-3 tw-my-auto tw-h-min tw-flex tw-justify-center">
                        <form action="/siswa-masuk" class="tw-text-center">
                            <input type="number" name="page"
                                class="tw-bg-white tw-border tw-border-slate-200 tw-w-1/2 tw-font-pop tw-font-medium tw-text-slate-500 tw-rounded-md tw-text-center focus:tw-ring-gray-200 focus:tw-border-gray-200 no-spin"
                            ...
                            @endif
                            @if (isset($_GET['diterima_di_kelas']))
                                <input name="diterima_di_kelas" value="{{ $_GET['diterima_di_kelas'] }}"
                                    type="hidden">
                            @endif
                            @if (isset($_GET['pindah_dari']))
                                <input name="pindah_dari" value="{{ $_GET['pindah_dari'] }}" type="hidden">
            ...
            @else
                <div class="tw-flex tw-justify-center">
                    <div class="tw-w-1/3 tw-my-28">
                        <img src="{{ URL::asset('assets/img/search-not-found.png') }}" class="-tw-mb-1"
                            alt="g ada dek">
