...
<div class="tw-mx-10">
    ...
    <div class="tw-flex tw-justify-between sm:tw-flex-wrap sm:tw-gap-5">
        ...
        <div class="flex">
        <a href="/create-mutasi-masuk" class="tw-bg-[#28A745] tw-text-white hover:tw-text-white hover:tw-bg-green-700 tw-font-pop tw-rounded-lg tw-px-5 tw-py-2">
                ...
                <tbody class="tw-text-base">
                    ...
                    <tr class="tw-bg-white tw-border">
                        ...
                        <td class="tw-flex tw-justify-center tw-my-2 tw-gap-2">
                            <a href="/edit-mutasi-masuk/{{ $m->id }}" class="tw-text-white tw-bg-kuning-500 hover:tw-bg-kuning-600 hover:tw-text-white tw-rounded-lg tw-text-xl tw-py-2 tw-px-3">
                                <i class="fa-solid fa-pen-to-square"></i></a>
                            </a>
                            <form action="/api/mutasi-masuk/delete/{{ $m->id }}" method="POST">
                            @csrf
                            @method('DELETE')
