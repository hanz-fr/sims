...
<body>
    <h4 style="font-weight: 500; text-align: center; margin-bottom: -10px">LAPORAN SISWA MUTASI MASUK</h4>
    <h4 style="font-weight: 500; text-align: center; margin-bottom: -10px">SMK NEGERI 11 BANDUNG</h4>
    <h5 style="font-weight: 500; text-align: center;">PERIODE {{ $tgl_masuk_dari }} - {{ $tgl_masuk_ke }}</h5>
