    ...
    @else
        <div class="tw-flex tw-justify-center">
                            ...
                            <div class="tw-relative tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100">
                                <div class="tw-p-6">
                                    ...
                                    <div
                                        ...
                                        Siswa dengan NIS tersebut tidak terdaftar</div>
                                    <div class="tw-flex tw-justify-center">
            ...
            <div
                ...
                <h3 class="tw-font-satoshi tw-font-semibold tw-mt-6 tw-text-sims-new-500 tw-text-center tw-mb-14">Edit Data
                    Mutasi Keluar</h3>
                <form action="/api/mutasi-keluar/update/{{ $mutasi->id }}" method="POST">
                    ...
                    <div class="tw-flex tw-flex-col tw-space-y-6">
                        ...
                        <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                            ...
                            <input value="{{ $mutasi->alasan_mutasi }}" @error('alasan_mutasi') is-invalid @enderror
                        ...
                        <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                            ...
                            <select class="input-data-minimal" id="keluar_di_kelas" name="keluar_di_kelas">
                                <option selected value="{{ $mutasi->keluar_di_kelas }}">{{ $mutasi->keluar_di_kelas }}
                                </option>
                                @foreach ($kelas as $k)
                        ...
                        <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                            ...
                            <input value="{{ $mutasi->pindah_ke }}" @error('pindah_ke') is-invalid @enderror
                        ...
                        <div class="tw-mx-auto md:tw-w-2/3 sm:tw-w-1/2">
                            ...
                            <input value="{{ $mutasi->sk_mutasi }}" @error('sk_mutasi') is-invalid @enderror
                        ...
                        <div class="tw-mx-auto tw-text-center tw-mt-10">
                            <button type="submit"
                                class="tw-bg-sims-new-500 tw-font-sg hover:tw-bg-sims-new-600 tw-font-medium tw-text-white tw-py-3 tw-transition tw-px-6 tw-rounded-lg">Update</button>
                        </div>
                    </div>
                </form>
            </div>
