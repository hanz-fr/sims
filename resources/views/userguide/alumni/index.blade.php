        ...
        <div class="tw-mx-60">
                    ...
                    <div class="tw-grid md:tw-grid-cols-2 sm:tw-grid-rows-1">
                        ...
                        <div class="tw-flex tw-flex-col md:tw-text-left tw-text-center tw-gap-y-5 tw-justify-center">
                            ...
                            <p class="hc-text-lg">
                                ...
                                halaman data alumni dengan menekan tombol dengan tombol 'Data Alumni' di kolom 'Quick
                                Access'.
            ...
            <div class="tw-flex tw-flex-col tw-mt-28">
                ...
                <div class="tw-grid tw-grid-cols-2 tw-gap-10">
                    ...
                    <div
                        class="tw-py-6 tw-px-8 tw-rounded-lg hover:tw-shadow-lg tw-transition-all tw-border tw-border-gray-200">
            ...
            <div class="tw-flex tw-flex-col tw-mt-28">
                ...
                <div
                    class="tw-w-full tw-px-14 tw-flex tw-drop-shadow-lg tw-justify-center tw-overflow-hidden tw-rounded-lg tw-mt-10">
