            ...
            <div class="tw-flex tw-flex-col tw-gap-10">
                ...
                <div class="tw-grid tw-grid-cols-3 hover:tw-text-white">
                    ...
                    <div class="hc-card-general">
                        ...
                        <p class="tw-text-justify hc-text-base tw-mt-2">dari penginputan manual di buku induk menjadi
                    ...
                    <div class="hc-card-general">
                        ...
                        <p class="tw-text-justify hc-text-base tw-mt-2">SIMS mampu meningkatkan kinerja operator sekolah,
                    ...
                    <div class="hc-card-general">
                        ...
                        <p class="tw-text-justify hc-text-base tw-mt-2">SIMS memungkinkan data ditransfer dengan lancar dari
                            satu bagian ke bagian lainnya. </p>
                    </div>
                ...
                <div class="tw-grid tw-grid-cols-2 tw-mt-24">
                    ...
                    <div class="tw-flex tw-pr-14">
                        <img src="{{ URL::asset('assets/img/hc-content-general.svg') }}" class="tw-w-full"
                            alt="hc-header-img">
                    </div>
