        ...
        <div class="tw-flex tw-flex-col tw-mt-28">
            ...
            <div class="tw-flex tw-flex-col md:tw-gap-24 tw-gap-12">
                ...
                <div class="tw-grid md:tw-grid-cols-2 sm:tw-grid-rows-1">
                    <div class="hc-img">
                        <img src="{{ URL::asset('assets/img/hc-rekapnilai-akses-1.svg') }}" alt="Sidebar Akses Data Induk Siswa">
                    </div>
            ...
            <div class="tw-flex tw-mt-10 tw-mx-12 tw-justify-center tw-items-center tw-gap-20">
                ...
                <div class="flex tw-flex-col tw-gap-y-10 tw-justify-center tw-items-center">
                    ...
                    <div class="tw-text-center">
                        <h4 class="tw-text-bluewood-800 hc-title-xl">Tambahkan file dengan menekan atau menyeret file ke kolom input</h4>
                        <p class="hc-text-lg">
                ...
                <div class="flex tw-flex-col tw-gap-y-10 tw-justify-center tw-items-center">
                    ...
                    <div class="tw-text-center">
                        ...
                        <p class="hc-text-lg">
                            ...
                            menekan tombol 'Ekspor', maka data sesuai dengan jumlah dan halaman yang anda pilih akan terunduh.
                        </p>
                    </div>
                </div>
