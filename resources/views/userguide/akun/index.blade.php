        ...
        <div class="tw-mx-60">
            <div class="tw-flex tw-flex-col">
                ...
                <div class="row">
                    ...
                    <h3 class="hc-title-2xl tw-mb-5"><span class="tw-text-bluewood-800">Langkah 1:</span> Login dengan akun
                        yang sudah ada</h3>
                ...
                <div class="tw-flex tw-flex-col tw-mx-12 tw-justify-center tw-pr-10 tw-mt-24">
                    ...
                    <div
                        class="tw-flex tw-gap-x-40 tw-pl-8 tw-pr-2 tw-mb-28 tw-flex-nowrap tw-max-w-full tw-pb-10 tw-overflow-x-scroll tw-scrollbar-thumb-gray-400 tw-scrollbar-thumb-rounded-lg tw-scrollbar-thin tw-scrollbar-track-gray-100">
