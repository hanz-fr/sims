...
<div class="tw-m-10 tw-flex">
   <div class="tw-flex tw-flex-col tw-w-full">
        <div class="tw-flex">
            ...
            <h4 class="tw-font-satoshi tw-font-bold tw-ml-2 tw-text-gray-500">Tambah Rekap Nilai Siswa</h4>
        </div>
        ...
        @method('POST')
            <div class="tw-flex tw-justify-center">
                <div class="card-data-bright tw-flex tw-justify-center tw-w-11/12 tw-mx-5 tw-mt-10 tw-py-12">
                    ...
                    <div class="tw-flex-col tw-flex tw-gap-5 tw-px-7 tw-py-7 tw-mb-5 tw-mt-5 tw-mx-10">
                        ...
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-lg tw-font-bold tw-mt-5 tw-text-gray-400">Naik ke Kelas</span>
                        ...
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-lg tw-font-bold tw-mt-5 tw-text-gray-400">Tanggal Kenaikan</span>
            ...
            <div class="tw-flex tw-justify-center">
                <div class="card-data-bright tw-flex tw-flex-col tw-w-11/12 tw-my-5">
                    ...
                    <div class="tw-flex tw-justify-center tw-gap-10 tw-mx-5 tw-px-20 tw-my-5 tw-py-10">
                        ...
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-lg tw-font-bold tw-mt-5 tw-text-gray-400">Tinggal di Kelas</span>
                        ...
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-lg tw-font-bold tw-mt-5 tw-text-gray-400">Alasan tidak naik</span>
                            <input type="text" class="tw-font-sg input-account" name="alasan_tidak_naik">
                        </div>
                    
                    </div>

                    <div class="tw-flex tw-justify-start tw-font-satoshi tw-text-xs tw-text-gray-400 tw-font-base tw-mx-10 tw-my-3">
            ...
            <div class="card-data-bright tw-flex tw-justify-between tw-gap-10 tw-w-4/6 tw-mx-5 tw-my-10 tw-py-20 tw-px-10">
                ...
                <div class="tw-px-5 tw-rounded-lg tw-bg-gray-100 tw-w-2/6">
                    <div class="tw-mt-5">
                    <span class="tw-font-satoshi tw-mt-5 tw-text-gray-400 tw-font-bold">Mata Pelajaran</span>
                    <select name="idMapelJurusan[]" id="idMapelJurusan" class="tw-font-sg input-account tw-px-10">
                ...
                <div class="tw-flex tw-gap-10">
                    ...
                    <div class="tw-flex tw-flex-col tw-gap-8">
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai Pengetahuan</span>
                            <input type="number" max="100" min="0" name="nilai_pengetahuan[]" id="nilai_pengetahuan" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div>

                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai Keterampilan</span>
                            <input type="number" max="100" min="0" name="nilai_keterampilan[]" id="nilai_keterampilan" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div>

                        {{-- <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">KKM</span>
                            <input type="number" max="100" min="0" name="kkm[]" id="kkm" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div> --}}
                    </div>
                    <div class="tw-flex tw-flex-col tw-gap-8">
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai US Teori</span>
                            <input type="number" max="100" min="0" name="nilai_us_teori[]" id="nilai_us_teori" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div>

                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai US Praktek</span>
                            <input type="number" max="100" min="0" name="nilai_us_praktek[]" id="nilai_us_praktek" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div>

                    </div>
                    <div class="tw-flex tw-flex-col tw-gap-8">
                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai UKK Teori</span>
                            <input type="number" max="100" min="0" name="nilai_ukk_teori[]" id="nilai_ukk_teori" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div>

                        <div>
                            <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai UKK Praktek</span>
                            <input type="number" max="100" min="0" name="nilai_ukk_praktek[]" id="nilai_ukk_praktek" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs">
                        </div>
                    </div>
                </div>
            ...
            <div class="tw-flex justify-center tw-mt-4">
                <button type="submit" class="tw-bg-sims-new-500 hover:tw-bg-sims-new-600 tw-transition-all tw-font-satoshi tw-font-medium tw-text-white tw-py-3 tw-px-6 tw-rounded-lg">Upload Data</button>
            </div>
        </form>
   </div>
</div>
