   ...
   <div class="tw-flex tw-flex-col tw-gap-8 tw-w-full">
        ...
        <li class="card-data-bright tw-mt-10">
            ...
            <div class="tw-text-end tw-mb-7">
                <a href="#" class="tw-mx-7 tw-my-3 tw-bg-green-400 hover:tw-bg-green-600 tw-rounded-xl tw-border tw-px-7 tw-py-3 tw-font-pop tw-text-slate-100 tw-font-4xl">Submit Nilai</a>
            </div>
   </div>
</div>
@endsection