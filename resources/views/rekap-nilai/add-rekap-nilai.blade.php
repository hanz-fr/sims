    ...
    <div class="tw-m-10 tw-flex">
        <div class="tw-flex tw-flex-col tw-w-full">
            ...
            <form action="/api/raport/tambah-nilai" method="POST">
                ...
                @else
                    <div
                        class="tw-text-center tw-font-satoshi tw-font-bold tw-text-sims-new-500 tw-text-2xl tw-mt-32 tw-mx-6">
                        Nilai Mapel
                    </div>
                @endif
                @foreach ($mapel as $m)
                    <div class="tw-flex tw-justify-center">
                        <div
                            ...
                            <div class="tw-px-5 tw-rounded-lg tw-bg-gray-100 tw-w-2/6">
                                <div class="tw-mt-5">
                                    <span class="tw-font-satoshi tw-mt-5 tw-text-gray-400 tw-font-bold">Mata
                                        Pelajaran</span>
                            ...
                            <div class="tw-flex tw-gap-10">
                                ...
                                <div class="tw-flex tw-flex-col tw-gap-8">
                                    <div>
                                        <span
                                            class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai
                                            Pengetahuan</span>
                                        <input type="number" max="100" min="0" name="nilai_pengetahuan[]"
                                    ...
                                    <div>
                                        <span
                                            class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai
                                            Keterampilan</span>
                                        <input type="number" max="100" min="0" name="nilai_keterampilan[]"
                                ...
                                <div class="tw-flex tw-flex-col tw-gap-8">
                                    ...
                                    <div>
                                        <span
                                            class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai
                                            US Praktek</span>
                                        <input type="number" max="100" min="0" name="nilai_us_praktek[]"
                                ...
                                <div class="tw-flex tw-flex-col tw-gap-8">
                                    <div>
                                        <span
                                            class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-xs tw-text-slate-400">Nilai
                                            UKK Teori</span>
                                        <input type="number" max="100" min="0" name="nilai_ukk_teori[]"
                ...
                <div class="tw-flex justify-center tw-mt-4">
                    <button type="submit"
                        class="tw-bg-sims-new-500 hover:tw-bg-sims-new-600 tw-transition-all tw-font-satoshi tw-font-medium tw-text-white tw-py-3 tw-px-6 tw-rounded-lg">Upload
                        Data</button>
                </div>
            </form>
        </div>
