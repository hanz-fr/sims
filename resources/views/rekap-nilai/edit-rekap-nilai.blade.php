          ...
          <div class="tw-flex tw-justify-center">
            <div class="card-data-bright tw-flex tw-justify-center tw-w-11/12 tw-mx-5 tw-mt-10 tw-py-12">
                <div class="tw-flex-col tw-flex tw-px-7 tw-py-7 tw-mb-5 tw-mt-5 tw-mx-10">
                    ...
                    <input type="text" placeholder="..." class="tw-font-sg input-account" name="thn_ajaran" value="{{ $raport->thn_ajaran }}">
                </div>

                <div class="tw-flex-col tw-flex tw-px-7 tw-py-7 tw-mb-5 tw-mt-5 tw-mx-10">
                    <span class="tw-font-satoshi tw-mx-3 tw-text-gray-400 tw-font-bold">Sakit</span>
                    <input type="number" placeholder="..." class="tw-font-sg input-account" name="sakit" value="{{ $raport->sakit }}">

                    <span class="tw-font-satoshi tw-mx-3 tw-mt-5 tw-text-gray-400 tw-font-bold">Izin</span>
                    <input type="number" placeholder="..." class="tw-font-sg input-account" name="ijin" value="{{ $raport->ijin }}">

                    <span class="tw-font-satoshi tw-mx-3 tw-mt-5 tw-text-gray-400 tw-font-bold">Alpha</span>
                    <input type="number" placeholder="..." class="tw-font-sg input-account" name="alpa" value="{{ $raport->alpa }}">
                </div>
                ...
                <div class="tw-flex-col tw-flex tw-gap-5 tw-px-7 tw-py-7 tw-mb-5 tw-mt-5 tw-mx-10">
                    ...
                    <div>
                        ...
                        <input type="date" class="tw-font-sg input-account" name="tgl_kenaikan" value="{{ $raport->tgl_kenaikan }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tw-flex tw-justify-center">
            <div class="card-data-bright tw-flex tw-flex-col tw-w-11/12 tw-my-5">
                ...
                <div class="tw-flex tw-justify-center tw-gap-10 tw-mx-5 tw-px-20 tw-my-5 tw-py-10">
                    ...
                    <div>
                        ...
                        <input type="text" class="tw-font-sg input-account" name="alasan_tidak_naik" value="{{ $raport->alasan_tidak_naik }}">
                    </div>
            ...
            <div class="card-data-bright tw-flex tw-justify-between tw-gap-10 tw-w-4/6 tw-mx-5 tw-my-10 tw-py-20 tw-px-10">
                ...
                <div class="tw-px-5 tw-rounded-lg tw-bg-gray-100 tw-w-2/6">
                    <div class="tw-mt-5">
                    <span class="tw-font-satoshi tw-mt-5 tw-text-slate-400 tw-font-bold">Mata Pelajaran</span>
                    <select name="idMapelJurusan[]" id="idMapelJurusan" class="tw-font-sg input-account tw-px-10">
                    <option value="{{ $nm->idMapelJurusan }}">{{ $nm->MapelJurusan->MapelId }}</option>
                    </select>
                    </div>
                </div>
                ...
                <div class="tw-flex tw-flex-col tw-gap-8">
                    <div>
                        <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-slate-400">Nilai Pengetahuan</span>
                    ...
                    <div>
                        <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-slate-400">Nilai Keterampilan</span>
                        <input type="number" min="0" max="100" name="nilai_keterampilan[]" id="nilai_keterampilan" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs" value="{{ $nm->nilai_keterampilan }}">
                    </div>
                ...
                <div class="tw-flex tw-flex-col tw-gap-8">
                    <div>
                        <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-slate-400">Nilai US Teori</span>
                    ...
                    <div>
                        <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-slate-400">Nilai US Praktek</span>
                        <input type="number" min="0" max="100" name="nilai_us_praktek[]" id="nilai_us_praktek" placeholder="" class="tw-block tw-text-gray-400 tw-w-full tw-font-satoshi tw-border tw-border-[#E3E3E3] tw-mt-2 tw-rounded-md tw-py-3 tw-px-8 tw-bg-white focus:tw-shadow-sm focus:tw-shadow-admin-300 focus:tw-border-admin-300 focus:tw-outline-none tw-text-xs" value="{{ $nm->nilai_us_praktek }}">
                    </div>
                </div>
                <div class="tw-flex tw-flex-col tw-gap-8">
                    <div>
                        <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-slate-400">Nilai UKK Teori</span>
                    ...
                    <div>
                        <span class="tw-font-satoshi tw-mx-3 tw-font-medium tw-text-slate-400">Nilai UKK Praktek</span>
