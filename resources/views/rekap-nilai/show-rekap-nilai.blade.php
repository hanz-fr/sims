...
@section('content')
    <div class="tw-mx-10">
        <div class="tw-flex tw-mt-8 tw-items-center">
            <a href="{{ URL::previous() }}" class=" tw-text-sims-new-500 tw-text-3xl hover:tw-text-sims-new-700"><i
                    class="fa-regular fa-chevron-left"></i></a>
            <div class="tw-text-2xl tw-text-sims-new-500 tw-font-satoshi tw-font-semibold tw-flex tw-ml-4">Rekap Nilai Siswa
            </div>
        </div>
            ...
            <div class="tw-my-auto tw-flex tw-gap-5 sm:tw-mt-2 lg:tw-my-auto">
                ...
                @cannot('kesiswaan')
                    <button type="button" data-modal-toggle="modal"
                        class="tw-bg-sims-new-500 tw-text-white hover:tw-text-white tw-font-sg hover:tw-bg-sims-new-700 tw-transition-all tw-px-5 tw-py-2 tw-rounded-lg">Export</button>
                ...
                @can('manage-nilai')
                    <a href="/tambah-nilai/{{ $siswa->nis_siswa }}"
                        class="tw-bg-sims-new-500 tw-text-white hover:tw-text-white  tw-font-sg hover:tw-bg-sims-new-700 tw-transition-all tw-px-5 tw-py-2 tw-rounded-lg">Tambah
                        Rekap Nilai +</a>
                @endcan
            </div>
        </div>
        <div x-data="{
                        ...
                        @foreach (collect($siswa->raport)->where('semester', 1) as $rp)
                            ...
                            <tr class="tw-bg-gray-50">
                                <th scope="row" rowspan="4"
                                    class="tw-py-2 tw-px-6 tw-font-medium tw-text-basic-700 tw-whitespace-nowrap tw-border">
                                    Absen
                                </th>
                            ...
                            <tr class="tw-bg-gray-100">
                                <th scope="row" rowspan="3"
                                    class="tw-bg-gray-50 tw-py-2 tw-px-6 tw-font-medium tw-text-basic-700 tw-whitespace-nowrap tw-border">
                                    Status Akhir Tahun
                                </th>
                                <td class="tw-py-2 tw-px-6 tw-border">
                                    Status Kenaikan
                            ...
                            <tr class="tw-bg-sims-new-600">
                                <td class="tw-py-10 tw-flex tw-justify-center tw-gap-10">
                                    <div class="tw-flex tw-gap-5 tw-justify-center">
                                        @can('update-nilai')
                                            <a href="/edit-rekap-nilai/{{ $rp->id }}"
                                                class="tw-text-white tw-text-sm tw-bg-yellow-400 hover:tw-text-white hover:tw-bg-yellow-500 tw-rounded-lg tw-py-2 tw-px-3">
                                ...
                                <td>
                                    <div
                                        class="tw-flex tw-justify-end  tw-font-satoshi tw-text-md tw-text-white tw-font-bold tw-mx-10">
                                        Tanggal dibuat : </div>
                                    <div class="tw-flex tw-justify-end  tw-font-satoshi tw-text-md tw-text-white tw-mx-10">
                                        {{ \Carbon\Carbon::parse(strtotime($rp->createdAt))->setTimezone('+7')->translatedFormat('l d F Y') }}
                                    </div>
                                </td>
                                <td></td>
                            </tr>
            ...
            <div class="tw-text-center tw-font-medium tw-mt-8 tw-mb-3 tw-text-gray-500 tw-font-satoshi tw-text-xl">SEMESTER
            </div>
            <div class="tw-flex tw-justify-center tw-gap-4 tw-mb-8">
                <a x-on:click="selected = 1" :class="selected === 1 ? activeClasses : inactiveClasses" href="#"
                ...
                <a x-on:click="selected = 2" :class="selected === 2 ? activeClasses : inactiveClasses" href="#"
                ...
                <a x-on:click="selected = 3" :class="selected === 3 ? activeClasses : inactiveClasses" href="#"
                ...
                <a x-on:click="selected = 4" :class="selected === 4 ? activeClasses : inactiveClasses" href="#"
                ...
                <a x-on:click="selected = 5" :class="selected === 5 ? activeClasses : inactiveClasses" href="#"
                ...
                <a x-on:click="selected = 6" :class="selected === 6 ? activeClasses : inactiveClasses" href="#"
