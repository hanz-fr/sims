    ...
    <div class="tw-mx-10">
        <div class="tw-flex lg:tw-flex-row sm:tw-flex-col tw-gap-8 tw-mt-8">
            ...
            <div class="tw-bg-white tw-grow tw-rounded-xl tw-p-10 tw-shadow-lg tw-font-pop tw-w-full">
                <div class="tw-text-base tw-text-gray-400 tw-font-bold tw-mb-3 tw-text-center">Grafik Perpindahan Siswa
                </div>
                <div class="tw-text-base tw-text-gray-400 tw-font-regular tw-mb-7 tw-text-center">Tahun {{ $current_year }}
                </div>
        ...
        <div class="tw-flex lg:tw-flex-row sm:tw-flex-col tw-gap-8 tw-my-8">
            <div
                class="tw-bg-white tw-flex tw-flex-col tw-rounded-xl tw-pt-3 tw-pb-12 tw-px-16 tw-shadow-lg tw-font-satoshi tw-w-full">
                @cannot('wali-kelas')
                    <div class="tw-float-right -tw-mr-8">
                        <a href="/rekap-jumlah-siswa"
                            class="tw-text-sims-new-500 hover:tw-text-sims-new-700 tw-pr-2 tw-mt-2 tw-text-sm tw-float-right"><i
                ...
                <div class="tw-grid lg:tw-grid-cols-3 md:tw-grid-cols-2 tw-gap-5 sm:tw-grid-cols-1 tw-mt-14">
                    <div class="shadow-card tw-bg-white tw-rounded-lg tw-pt-7 tw-pb-10 lg:tw-px-14 tw-px-10 tw-text-center">
                        ...
                        <h1 class="tw-text-sims-new-500 tw-font-medium tw-text-6xl tw-font-sg tw-pt-6">{{ $jumlahSiswaX }}
                        </h1>
                    </div>
                    <div class="shadow-card tw-bg-white tw-rounded-lg tw-pt-7 tw-pb-10 lg:tw-px-14 tw-px-10 tw-text-center">
                        <h2 class="tw-text-gray-500 tw-font-bold tw-text-2xl">KELAS XI</h2>
                        <h1 class="tw-text-sims-new-500 tw-font-medium tw-text-6xl tw-font-sg tw-pt-6">{{ $jumlahSiswaXI }}
                        </h1>
                    </div>
                    <div class="shadow-card tw-bg-white tw-rounded-lg tw-pt-7 tw-pb-10 lg:tw-px-14 tw-px-10 tw-text-center">
                        <h2 class="tw-text-gray-500 tw-font-bold tw-text-2xl">KELAS XII</h2>
                        <h1 class="tw-text-sims-new-500 tw-font-medium tw-text-6xl tw-font-sg tw-pt-6">{{ $jumlahSiswaXII }}
                        </h1>
                    </div>
                </div>
            </div>
            ...
            {{-- Quick Access --}}
            <div
                class="tw-bg-white tw-rounded-xl tw-p-14 tw-shadow-lg tw-flex tw-flex-col tw-items-center tw-justify-center tw-font-satoshi lg:tw-w-3/4 tw-w-full">
                ...
                <div class="tw-grid tw-grid-cols-2 tw-gap-8 tw-mt-8 tw-items-center tw-justify-center">
                    @can('manage-alumni')
                        <a href="/siswa-masuk" class="tw-group">
                            <div
                                class="tw-flex tw-flex-col tw-justify-center tw-text-center tw-border-2 tw-py-4 tw-bg-white tw-rounded-lg group-hover:tw-text-white group-hover:tw-bg-sims-new-500 tw-transition-all tw-duration-300">
                                <div class="tw-text-2xl tw-text-sims-new-500 group-hover:tw-text-white"><i
                                        class="fa-solid fa-graduation-cap"></i></div>
                                <div class="tw-text-base tw-text-gray-500 tw-font-normal tw-mt-3 group-hover:tw-text-white">Data
                                    Mutasi Masuk</div>
                            </div>
                        </a>
                    @endcan
                    ...
                    <a href="/select-jurusan-alumni" class="tw-group">
                        <div
                            class="tw-flex tw-flex-col tw-justify-center tw-text-center tw-border-2 tw-py-4 tw-bg-white tw-rounded-lg group-hover:tw-text-white group-hover:tw-bg-sims-new-500 tw-transition-all tw-duration-300">
                            <div class="tw-text-2xl tw-text-sims-new-500 group-hover:tw-text-white"><i
                    ...
                    @cannot('wali-kelas')
                        <a href="/data-tidak-naik" class="tw-group">
                            <div
                                ...
                                <div
                                    class="tw-text-base tw-text-gray-500 tw-font-normal tw-mt-3 group-hover:tw-text-white tw-px-2">
                                    Data Siswa Tidak Naik Kelas</div>
                            </div>
                        </a>
                    @endcannot
