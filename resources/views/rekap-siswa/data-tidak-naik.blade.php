            ...
            <div class="tw-flex tw-my-auto">
                <form action="/data-tidak-naik">
                    <div class="relative tw-border-[1.5px] tw-border-gray-300 tw-rounded-xl">
                        ...
                        @endif
                        @if (isset($_GET['tinggal_di_Kelas']))
                            <input name="tinggal_di_Kelas" value="{{ $_GET['tinggal_di_Kelas'] }}" type="hidden">
                        @endif
                        @if (isset($_GET['alasan_tidak_naik']))
                            <input name="alasan_tidak_naik" value="{{ $_GET['alasan_tidak_naik'] }}" type="hidden">
                        @endif
                        @if (isset($_GET['tmp_lahir']))
                            <input name="tmp_lahir" value="{{ $_GET['tmp_lahir'] }}" type="hidden">
                        @endif
                        @if (isset($_GET['tgl_lahir']))
                            <input name="tgl_lahir" value="{{ $_GET['tgl_lahir'] }}" type="hidden">
                        @endif
                ...
                <div class="tw-flex tw-mx-1 tw-my-auto">
                    ...
                    <button id="dropdownToggleButton" data-dropdown-toggle="filter-dd"
                     ...
                     type="button">Filters
                        <i class="tw-text-xl tw-ml-5 fa-duotone fa-sliders-simple"></i></button>
                            ...
                            <ul class="tw-p-3 tw-space-y-1 tw-text-sm tw-text-gray-700"
                                ...
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="tmp_lahir"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['tmp_lahir']) @if ($_GET['tmp_lahir'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Tempat
                                                Lahir</span>
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="tgl_lahir"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['tgl_lahir']) @if ($_GET['tgl_lahir'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                ...
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="tinggal_di_Kelas"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['tinggal_di_Kelas']) @if ($_GET['tinggal_di_Kelas'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                                class="tw-ml-3 tw-text-xs tw-font-medium tw-text-gray-500 dark:text-gray-300">Tinggal
                                                di Kelas</span>
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div
                                        ...
                                        <label
                                            class="tw-inline-flex tw-relative tw-items-center tw-w-full tw-cursor-pointer">
                                            <input type="checkbox" value="true" name="alasan_tidak_naik"
                                                class="tw-sr-only tw-peer focus:tw-ring-0 focus:tw-ring-offset-0"
                                                @isset($_GET['alasan_tidak_naik']) @if ($_GET['alasan_tidak_naik'] === 'true') checked @endif @endisset>
                                            <div
                                                class="tw-w-9 tw-h-5 tw-bg-gray-200 peer-focus:tw-outline-none tw-rounded-full tw-peer peer-checked:after:tw-translate-x-full peer-checked:after:tw-border-white after:tw-content-[''] after:tw-absolute after:tw-top-[2px] after:tw-left-[2px] after:tw-bg-white after:tw-border-gray-300 after:tw-border after:tw-rounded-full after:tw-h-4 after:tw-w-4 after:tw-transition-all peer-checked:tw-bg-sims-new-500">
                                            </div>
                                            <span
                                ...
                                <div class="tw-absolute tw-right-4 tw-top-2">
                                    ...
                                    <a tabindex="0" role="link" aria-label="tooltip 1"
                                        ...
                                        <div id="tooltip1" role="tooltip"
                                            ...
                                            <p class="text-sm font-bold text-gray-800 pb-1">Data periodik Tidak Naik Kelas
                                            </p>
                                            <p class="text-xs leading-4 text-gray-600">Data diambil berdasarkan tanggal
                                                dibuatnya rekap nilai siswa yang memiliki keterangan 'Tidak Naik'.</p>
                                        </div>
                                    </a>
                        ...
                        <div class="tw-relative tw-p-4 tw-w-full tw-max-w-md tw-h-full md:tw-h-auto">
                            <div class="tw-relative tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-slate-100">
                                ...
                                <form action="/data-tidak-naik-print" target="__blank" method="">
                                    @csrf
                                    <div class="tw-p-6">
                                        <div class="tw-text-gray-400 tw-font-pop tw-text-center tw-font-semibold tw-text-lg">
                                            Cetak Data</div>
                                        <div class="tw-flex tw-gap-3 tw-justify-between tw-mt-5 tw-mx-5">
                                            <div>
                                            ...
                                            <div>
                                                <div class="tw-text-xs tw-mb-2 tw-font-pop tw-font-normal tw-text-gray-400">Ke
                                                    tanggal</div>
                                                <input class="input-data tw-text-xs tw-font-pop" id="dibuatTglKe"
